    ...
    var guy = setTimeout(male, 500);
      ...
      switch (e.target.id) {
        ...
        case "akihiro-btn":
          ...
          info.textContent = "Living in the slums as a child with his only friend 'Maki', Akihiro Sokuru pulled himself from his bootstraps and aggressively climbed his way to the top of the business world involving a series of suspicious scandals and forced resignations of his competitors. Intelligent, charismatic, and highly competitive, Akihrio continues to strive to higher power, even competing against his childhood friend for higher office. With his contrasting views on Nekos, Akihiro poses a great threat to Nagamichi's goals.";
          break;
    ...
    function female() {
      ...
      switch (e.target.id) {
        ...
        case "miyame-btn":
          ...
          info.textContent = "She appears in Yutei's life suddenly and now lives with him and his family as if by chance. Miyame is energetic, untamed and innocent. She is as cute as she is uncontrollable, and an enigma to Asako who can't seem to shake off something off about her scent. Her childlike love for Yutei makes her a cute little sister that Yutei never expected.";
          break;
        ...
        case "sabrina-btn":
          ...
          info.textContent = "Estranged to her sister, Sabrina shows no interest in following Sayaka's self righteous footstep in education and integrity. Sabrina uses her looks and charm to get what she want from the men she swoons, whether its money, food, or information. Recently she's been absent from both school and home more often than usual and Sayaka is very worried. If not for her sister's sake, at least she is worried that people will connect Sabrina's being a Neko to her own identity.";
          break;
        ...
        case "allie-btn":
          ...
          info.textContent = "An enigmatic and quirky character bordering somewhere between insanely dispassionate, to passionately insane with her quips and logic. Allie is a great source of entertainment and pop culture references. Her passion for food is only match by her passion to insult Yutei whenever possible.";
          break;
        ...
        case "mingita-btn":
          ...
          info.textContent = "A fun sarcastic character whose need for money causes her to show up in various places randomly due to her constant search for a new part-time job.";
          break;
